...
def negative_assert_symbol(first_name):
    ...
    # Проверяется, что в ответе есть поле code, и оно равно 400
    assert user_response.json()["code"] == 400
    # Проверяется, что в теле ответа, в атрибуте message сообщение о некорректности имени
...
# Параметр fisrtName состоит из символов русского алфавита
...
# Тест 12. Ошибка
# Параметр firstname содержит не текстовое значение
